...
declare const VTab: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            "v-slot:default"?: false | (() => vue.VNodeChild) | undefined;
        } & vue.VNodeProps & vue.AllowedComponentProps & vue.ComponentCustomProps, "replace" | "fixed" | "exact" | "direction" | "disabled" | "size" | "tag" | "rounded" | "density" | "variant" | "selectedClass" | "stacked" | "ripple" | "hideSlider">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
