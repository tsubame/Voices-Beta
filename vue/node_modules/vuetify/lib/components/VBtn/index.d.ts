...
declare const VBtn: {
    new (...args: any[]): {
        ...
        } & vue.VNodeProps & vue.AllowedComponentProps & vue.ComponentCustomProps, "symbol" | "replace" | "flat" | "exact" | "active" | "block" | "disabled" | "size" | "tag" | "rounded" | "density" | "variant" | "stacked" | "ripple">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
