...
import { Codec, ContentType, EncodingParameters, LocalAudioStream, LocalStream, LocalVideoStream, Publication, PublicationState, ReplaceStreamOptions, TransportConnectionState, WebRTCStats } from '@skyway-sdk/core';
...
export interface RoomPublication<T extends LocalStream = LocalStream> {
     ...
     */
    replaceStream: (stream: LocalAudioStream | LocalVideoStream, options?: ReplaceStreamOptions) => void;
    /**
     * @experimental
...
export declare class RoomPublicationImpl<StreamType extends LocalStream = LocalStream> implements RoomPublication {
    ...
    readonly replaceStream: (stream: LocalAudioStream | LocalVideoStream, options?: ReplaceStreamOptions) => void;
    /**@internal */
    _dispose(): void;
