...
import { LocalPerson, LocalPersonAdapter, PublicationOptions, RemoteAudioStream, RemoteDataStream, RemoteStream, RemoteVideoStream, SubscriptionOptions } from '@skyway-sdk/core';
...
export declare abstract class LocalRoomMemberImpl extends RoomMemberImpl implements LocalRoomMember {
    ...
    get subscriptions(): import("../../subscription").RoomSubscriptionImpl<RemoteStream>[];
