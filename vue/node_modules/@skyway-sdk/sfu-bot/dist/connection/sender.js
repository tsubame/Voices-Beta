...
class Sender {
    ...
    startForwarding(configure) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // optional
            broadcasterTransportOptions, rtpCapabilities, ackTransportId, ackTransportOptions, ackProducerId, ackConsumerOptions, } = yield this._api.startForwarding({
                botId: this._bot.id,
                publicationId: this.publication.id,
                contentType: this.publication.contentType,
                maxSubscribers: configure.maxSubscribers,
            ...
            if (ackTransportOptions) {
                this._ackTransport = this._transportRepository.createTransport(this._localPerson.id, this._bot, ackTransportOptions, 'recv', this._iceManager);
                const ackConsumer = yield this._ackTransport.msTransport.consumeData(ackConsumerOptions);
                ackConsumer.addListener('open', () => __awaiter(this, void 0, void 0, function* () {
                ...
                this._broadcasterTransport.onProduceData
                    .watch((e) => { var _a; return ((_a = e.producerOptions.appData) === null || _a === void 0 ? void 0 : _a.transactionId) === transactionId; })
                    .then(({ callback }) => {
            ...
            this._ackTransport = this._transportRepository.getTransport(this._localPerson.id, ackTransportId);
            if (!this._ackTransport) {
                throw (0, core_1.createError)({
                    operationName: 'Sender.startForwarding',
                    context: this._context,
                    info: Object.assign(Object.assign({}, errors_1.errors.internal), { detail: '_ackTransport not found' }),
                    path: log.prefix,
                    channel: this.channel,
                    payload: { ackTransportOptions, broadcasterTransportOptions },
                });
            ...
            this._setupTransportAccessForStream(stream, this._broadcasterTransport, producer);
            ...
            const forwarding = new forwarding_1.Forwarding(configure, this.publication, relayingPublication);
            ...
            (0, core_1.waitForLocalStats)(stream, this._bot.id, (stats) => !!stats.find((s) => s.type.includes('local-candidate')))
    ...
    _produce(stream, transport) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            this.publication._onReplaceStream
                .add((stream) => __awaiter(this, void 0, void 0, function* () {
                this._listenStreamEnableChange(stream);
                yield this._replaceTrack(stream.track);
            }))
                    ...
                    case 'request':
                        {
                            ...
                            const exist = this.channel.subscriptions.find((subscription) => subscription.publication.id === publicationId &&
                                subscription.subscriber.id === subscriberId);
                            if (!exist) {
                                yield this.channel.onPublicationSubscribed
                                    .watch(({ subscription }) => subscription.publication.id === publicationId &&
                                    subscription.subscriber.id === subscriberId, this._bot.options.ackTimeout)
                                    .catch((e) => {
                                    throw (0, core_1.createError)({
                                        operationName: 'Sender._handleMessage',
                                        context: this._context,
                                        info: Object.assign(Object.assign({}, errors_1.errors.timeout), { detail: 'ackConsume publication.onSubscribed' }),
                                        path: log.prefix,
                                        channel: this.channel,
                                        error: e,
                                        payload: {
                            ...
                            for (let i = 0; i < 10; i++) {
                                try {
                                    ...
                                    log.error((0, core_1.createError)({
                                        operationName: 'Sender._handleMessage',
                                        context: this._context,
                                        info: Object.assign(Object.assign({}, errors_1.errors.internal), { detail: 'An error occurred in producer.send' }),
                                        path: log.prefix,
                                        channel: this.channel,
                                        error,
                                        payload: {
