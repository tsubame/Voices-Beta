...
class Receiver extends peer_1.Peer {
    ...
    _setupTransportAccessForStream(stream) {
        stream._getTransport = () => ({
            ...
            connectionState: (0, __1.convertConnectionState)(this.pc.connectionState),
        });
    ...
    _getCodecFromSdp(sdpObject, transceiver, kind) {
        ...
        if (fmtp === null || fmtp === void 0 ? void 0 : fmtp.config) {
            parameters = (0, __1.fmtpConfigParser)(fmtp.config);
        }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.pc.signalingState !== 'stable') {
                if (this.isWrongSignalingState) {
                    this._log.warn('_handleSenderProduce wait for be stable', (0, __1.createWarnPayload)({
    ...
    _handleSenderUnproduce({ sdp, publicationId, }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.pc.signalingState === 'closed') {
                this._log.warn('signalingState closed', (0, __1.createWarnPayload)({
                    channel: this.localPerson.channel,
            ...
            if (this.pc.signalingState !== 'stable') {
                if (this.isWrongSignalingState) {
                    this._log.warn('signalingState is not stable', (0, __1.createWarnPayload)({
                        channel: this.localPerson.channel,
