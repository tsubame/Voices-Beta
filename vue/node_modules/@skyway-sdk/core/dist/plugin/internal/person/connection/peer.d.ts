...
import { LocalPersonImpl, P2PMessage, RemoteMember } from '../../../..';
...
export declare abstract class Peer {
    ...
    /**@throws {@link SkyWayError} */
    protected waitForStats: (track: MediaStreamTrack, cb: (stats: any[]) => boolean, interval?: number, timeout?: number) => Promise<void>;
}
