...
/**@internal */
function createLocalPerson(context, channel, memberDto, { keepaliveIntervalSec, keepaliveIntervalGapSec, } = {}) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const signalingSession = context.config.internal.disableSignaling === true
            ? undefined
            : yield (0, signaling_1.setupSignalingSession)(context, channel, memberDto);
        const iceManager = new __1.IceManager(Object.assign(Object.assign({}, iceParamServer), { memberId: memberDto.id, channelId: channel.id, ttl: const_1.MaxIceParamServerTTL, context }));
