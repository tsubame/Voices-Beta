...
/**@internal */
class LocalPersonImpl extends __2.MemberImpl {
    /**@private */
    constructor(args) {
        super(args);
        this.args = args;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.ttlInterval = setInterval(() => __awaiter(this, void 0, void 0, function* () {
                yield updateTtl().catch((error) => {
                    if (!this._disposed) {
                        this.onFatalError.emit((0, __1.createError)({
    ...
    _handleOnPublicationSubscribe(subscription) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (subscription.subscriber.id === this.id) {
                try {
                    const timestamp = log.info('[start] startSubscribing', yield (0, __1.createLogPayload)({
                    ...
                    log.elapsed(timestamp, '[end] startSubscribing', yield (0, __1.createLogPayload)({
                        operationName: 'onPublicationSubscribed',
                        channel: this.channel,
                    }), {
                        subscription,
            ...
            if (subscription.publication.publisher.id === this.id) {
                ...
                const timestamp = log.info('[start] startPublishing', yield (0, __1.createLogPayload)({
                    operationName: 'onPublicationSubscribed',
                    channel: this.channel,
                }), { subscription });
                ...
                log.elapsed(timestamp, '[end] startPublishing', yield (0, __1.createLogPayload)({
                    operationName: 'onPublicationSubscribed',
                    channel: this.channel,
                }), { subscription });
            }
    ...
    _handleOnPublicationUnsubscribe(subscription) {
        return __awaiter(this, void 0, void 0, function* () {
            if (subscription.publication.publisher.id === this.id) {
                const timestamp = log.info('[start] stopPublishing', yield (0, __1.createLogPayload)({
                ...
                log.elapsed(timestamp, '[end] stopPublishing', yield (0, __1.createLogPayload)({
                    operationName: 'onPublicationUnsubscribed',
                    channel: this.channel,
                }), { subscription });
            }
            if (subscription.subscriber.id === this.id) {
                const timestamp = log.info('[start] stopSubscribing', yield (0, __1.createLogPayload)({
                    operationName: 'onPublicationUnsubscribed',
                    channel: this.channel,
                }), { subscription });
                ...
                this.onSubscriptionListChanged.emit();
                log.elapsed(timestamp, '[end] stopSubscribing', yield (0, __1.createLogPayload)({
                    operationName: 'onPublicationUnsubscribed',
                    channel: this.channel,
                }), { subscription });
            }
    ...
    publish(stream, options = {}) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            const timestamp = log.info('[start] publish', yield (0, __1.createLogPayload)({
            ...
            log.elapsed(timestamp, '[end] publish', yield (0, __1.createLogPayload)({
                operationName: 'localPerson.publish',
                channel: this.channel,
            }), { publication });
            return publication;
    ...
    _handleOnStreamPublish(publication) {
        return __awaiter(this, void 0, void 0, function* () {
            log.info('onStreamPublished', yield (0, __1.createLogPayload)({
    ...
    unpublish(target) {
        return __awaiter(this, void 0, void 0, function* () {
            const timestamp = log.info('[start] unpublish', yield (0, __1.createLogPayload)({
            ...
            log.elapsed(timestamp, '[end] unpublish', yield (0, __1.createLogPayload)({
                operationName: 'localPerson.unpublish',
                channel: this.channel,
            }), { publication });
        });
    ...
    _handleOnStreamUnpublished(publication) {
        return __awaiter(this, void 0, void 0, function* () {
            log.info('onStreamUnpublished', yield (0, __1.createLogPayload)({
    ...
    subscribe(target, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const timestamp = log.info('[start] subscribe', yield (0, __1.createLogPayload)({
            ...
            try {
                ...
                log.elapsed(timestamp, '[end] subscribe', yield (0, __1.createLogPayload)({
                    operationName: 'localPerson.subscribe',
                    channel: this.channel,
    ...
    unsubscribe(target) {
        return __awaiter(this, void 0, void 0, function* () {
            const timestamp = log.info('[start] unsubscribe', yield (0, __1.createLogPayload)({
            ...
            log.elapsed(timestamp, '[end] unsubscribe', yield (0, __1.createLogPayload)({
                operationName: 'localPerson.unsubscribe',
                channel: this.channel,
            }), { subscription });
        });
