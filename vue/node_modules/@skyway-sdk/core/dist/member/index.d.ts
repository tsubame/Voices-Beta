...
import { LocalStream, Publication, RemoteAudioStream, RemoteDataStream, RemoteVideoStream, SkyWayContext, Subscription } from '..';
...
export declare abstract class MemberImpl implements Member {
    ...
    get subscriptions(): Subscription<import("..").RemoteStream>[];
    /**@internal */
    toJSON(): model.Member;
    /** @private*/
    _left(): void;
