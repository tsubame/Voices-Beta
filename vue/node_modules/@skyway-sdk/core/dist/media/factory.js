    ...
    createDisplayStreams(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            videoOption.stopTrackWhenDisabled =
                (_b = videoOption.stopTrackWhenDisabled) !== null && _b !== void 0 ? _b : true;
            let audioOption = options.audio;
            if (audioOption) {
                audioOption = {};
                audioOption.stopTrackWhenDisabled =
                    (_c = audioOption.stopTrackWhenDisabled) !== null && _c !== void 0 ? _c : true;
            }
            ...
            const videoStream = new video_1.LocalVideoStream(video, Object.assign(Object.assign({}, options.video), { isDisplayMedia: true }));
            videoStream._setLabel('displayVideo');
            const audioStream = audio
                ? new audio_1.LocalAudioStream(audio, Object.assign(Object.assign({}, (typeof options.audio === 'boolean' ? {} : options.audio)), { isDisplayMedia: true }))
                : undefined;
            if (audioStream) {
