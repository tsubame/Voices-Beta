...
class LocalStreamBase {
    ...
    _getConnectionState(selector) {
        var _a, _b;
        return (_b = (_a = this._getTransport(selector)) === null || _a === void 0 ? void 0 : _a.connectionState) !== null && _b !== void 0 ? _b : 'new';
    }
    /**@internal */
    _getConnectionStateAll() {
        return Object.entries(this._getTransportCallbacks).map(([memberId, cb]) => ({ memberId, connectionState: cb().connectionState }));
    }
    /**@internal */
    toJSON() {
        return {
