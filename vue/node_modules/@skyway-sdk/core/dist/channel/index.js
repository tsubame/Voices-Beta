...
class SkyWayChannelImpl {
    ...
    _channelImpl) {
        ...
        this.close = () => new Promise((r, f) => __awaiter(this, void 0, void 0, function* () {
            ...
            const timestamp = log.info('[start] close channel', yield (0, __1.createLogPayload)({
                operationName: 'SkyWayChannelImpl.close',
                channel: this,
            }));
            try {
            ...
            log.elapsed(timestamp, '[end] close channel', yield (0, __1.createLogPayload)({
                operationName: 'SkyWayChannelImpl.close',
                channel: this,
            }));
            r();
    ...
    join(options = {}) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const timestamp = log.info('[start] join', yield (0, __1.createLogPayload)({
            ...
            options.keepaliveIntervalSec =
                (_a = options.keepaliveIntervalSec) !== null && _a !== void 0 ? _a : this.config.member.keepaliveIntervalSec;
            options.keepaliveIntervalGapSec =
                (_b = options.keepaliveIntervalGapSec) !== null && _b !== void 0 ? _b : this.config.member.keepaliveIntervalGapSec;
    ...
    _createLocalPerson(member, { keepaliveIntervalSec, keepaliveIntervalGapSec, }) {
        return __awaiter(this, void 0, void 0, function* () {
